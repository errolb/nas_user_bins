...
var lookUpDir ='/home/' + username + '/.all_media_symlinks/movies_anime';
var writeFolder = '/home/' + username + '/Dropbox/_global/_torrent_watch';
var listName = 'animemovielist.md';
...
processDir(function(files) {
	var md = '';
	var title = '# Live Anime Movies List';
	...
	fs.writeFile(completePath, md, function(err){ 
		if (err) throw err;
		console.log('Live Anime Movie List updated.');
	});
